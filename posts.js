...

{
  ...
  body: `
<p class="body">접속 주소는 <b>34.104.215.151</b> 입니다. 아래 순서대로 준비하면 됩니다.</p>
...
<div class="callout">
  <h3>인증서 등록 창은 전부 넘기세요</h3>
  <p>서버에 접속하면 AutoModpack이 <b>인증서를 등록하겠냐고 묻는 창</b>을 띄웁니다. <b>전부 스킵하고 넘어가면 됩니다.</b> 등록하지 않아도 모드팩은 그대로 받아지고 접속도 정상입니다. 여러 번 떠도 똑같이 넘기세요.</p>
</div>
